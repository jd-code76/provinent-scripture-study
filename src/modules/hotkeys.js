...
/* Initialize hotkeys if they don't exist */
...
/* Handle keypress events for navigating between books and chapters */
export function handleKeyPress(e) {
    // Always allow F1 key, even if hotkeys are disabled
...
/* Get a human-readable hotkey display string */
...
/* Toggle hotkeys enabled/disabled */
...
/* Show the help modal with hotkey information */
...
/* Populate the hotkeys list in the help modal */
...
/* Setup event listeners for help modal elements */
...
/* Start recording a new hotkey for the given action */
function startHotkeyRecording(action, buttonElement) {
    ...
    // Store original state and temporarily disable hotkeys
    ...
    function recordKeypress(e) {
        ...
        // Ignore modifier keys alone and Escape key
