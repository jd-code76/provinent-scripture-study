/*=====================================================================
  Provinent Scripture Study – pdf.js
=====================================================================*/
...
/* ====================================================================
   INDEXEDDB HELPERS
   Store and retrieve PDF files from browser's IndexedDB
   (More efficient than localStorage for large binary data)
==================================================================== */
...
/**
 * Save PDF data to IndexedDB storage
...
/**
 * Load PDF data from IndexedDB storage
...
/**
 * Delete PDF data from IndexedDB storage
 * @returns {Promise<void>}
 */
...
/* ====================================================================
   PDF HANDLERS
   Upload, load, render, and navigate PDF documents
==================================================================== */

/*  Handle PDF file upload from settings */
...
/* Update the PDF info display in settings */
export function updateCustomPdfInfo() {
    ...
    if (state.settings.customPdf) {
        ...
        // Also reset PDF UI when no PDF is present
...
/* Remove custom PDF from IndexedDB and state */
...
/* Load PDF from IndexedDB into the viewer with proper initialization */
...
/* Clean up PDF.js resources when the page is unloading */
export function setupPDFCleanup() {
    window.addEventListener('beforeunload', () => {
        ...
        // Don't destroy pdf.doc - let browser handle garbage collection
    });
}

/* Render a single PDF page onto the canvas */
...
/* Search PDF for text and navigate to first match */
...
/* Clear PDF search query contents */
...
/* Navigate/move to the current PDF search result with proper rendering */
...
/* Clear the currently highlighted PDF search result */
